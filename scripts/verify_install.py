...
def main():
    ...
    run = wandb.init(project="Jormungandr-Semantica", job_type="verification")
    ...
    config = {"n_points": 100, "n_dims": 16, "k": 10, "data_source": "random_uniform"}
    ...
    try:
        neighbors, distances = aglt.build_faiss_knn_graph(data, config["k"])
