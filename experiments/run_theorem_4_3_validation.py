...
def main():
    ...
    This script generates a series of barbell graphs with increasing clique sizes,
    computes their spectral gap and bridge curvature, and saves the results
    ...
    for m in clique_sizes:
        ...
        results.append({"m": m, "lambda_2": spectral_gap, "kappa_bridge": curvature})
